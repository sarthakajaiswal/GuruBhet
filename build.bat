...
rc.exe OGL.rc 
link.exe /OUT:OGL.exe *.obj OGL.res user32.lib gdi32.lib kernel32.lib /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\um\x64" /SUBSYSTEM:WINDOWS 
